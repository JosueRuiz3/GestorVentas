...
BEGIN
	...
	INSERT INTO Productos(NombreProducto, PrecioUnidad, PrecioVenta, UnidadesEnExistencia, CodigoProducto, Descripcion,IdCategoria)
	VALUES(@NombreProducto, @PrecioUnidad, @PrecioVenta, @UnidadesEnExistencia, @CodigoProducto, @Descripcion,@IdCategoria)
...
EXEC SP_Guardar_Producto
	...
	@Descripcion = 'NEGRO 99% GRANO ENTERO 1,8kg',
	@IdCategoria =  4
GO

EXEC SP_Listar_Producto;REATE DATABASE GestorVentas;
...
BEGIN
	...
	INSERT INTO Productos(NombreProducto, PrecioUnidad, PrecioVenta, UnidadesEnExistencia, CodigoProducto, Descripcion)
	VALUES(@NombreProducto, @PrecioUnidad, @PrecioVenta, @UnidadesEnExistencia, @CodigoProducto, @Descripcion)
